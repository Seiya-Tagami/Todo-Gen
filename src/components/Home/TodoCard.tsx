    ...
    <Form class="w-full m-h-full p-6 bg-white border border-gray-200 rounded-lg shadow" action={action}>
      ...
      <div class="flex justify-end">
        {text !== "Let's find what to do next!" && (
          <button class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-teal-600 rounded-lg hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-blue-300" type="submit">
            Add
